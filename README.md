...
## Dependencies
This collection uses [cisco.intersight](https://galaxy.ansible.com/ui/repo/published/cisco/intersight) certified ansible collection and [Cisco Intersight API](https://intersight.com/apidocs/introduction/overview/) to automate provisioning and management of Intersight Managed UCS servers.
